# AI Radar - Claude Code Skill
 ...
 Hi, I'm Scarlett 👋
  ▎
  ▎ 我是一个对 AI 行业充满好奇心的产品人。每天早上打开电脑，我都面临同一个问题：昨晚 AI 世界又发生了什么？
  ▎
  ▎ Sam Altman 又发了什么推？Karpathy 在聊什么新想法？Sequoia 的播客又请了谁？a16z 在关注什么趋势？这些信息散落在
  ▎ YouTube、Twitter、播客等十几个平台上，光是刷一遍就要花掉一个小时。
  ▎
  ▎ 所以我做了 AI Radar。
  ...
  ▎ Why AI Radar
  ▎
  ▎ 这个 skill 的设计理念很简单：让 AI 帮你追踪 AI。
  ▎
  ▎ 我不想再做一个需要注册、需要付费、需要打开另一个 App 的信息产品。AI Radar 就是一个 Markdown 文件——你把它放进 Claude
  ▎ Code 的 commands 目录，输入 /ai-radar，等两分钟，一份覆盖 12 个 YouTube 频道、5 个顶级 AI 播客、22 位行业 KOL
  ▎ 推文的中文日报就生成了。
  ▎
  ▎ 没有后端，没有数据库，没有订阅费。RSSHub 实例是自己的，数据流向完全透明。
  ▎ KOL、换掉播客源、调整输出格式——因为它就是一个你能完全看懂和修改的文本文件。
  ▎
  ▎ 我相信最好的工具是那些你拥有它，而不是它拥有你的工具。


  ▎ 最后
  ▎
  ▎ 如果这个小工具帮你每天省下了哪怕 10 分钟的信息筛选时间，我就很开心了。
  ▎
  ▎ 我们正处在一个不可思议的时代——AI 每天都在创造新的可能性，而我们能做的最好的事情，就是保持关注、保持学习、保持建造。
  ▎
  ▎ Happy building 🚀
  ▎
  ▎ — ScarlettLiu（刘静）20260422
